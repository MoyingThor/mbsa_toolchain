 ...
 * @generated
 */
public class CauseItemProvider extends HazardElementItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Hazard_Package.Literals.CAUSE__CONTROL_MEASURE);
		}
	...
	public String getText(Object object) {
		String label = ((Cause)object).getGid();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Hazard_Package.Literals.CAUSE__CONTROL_MEASURE,
